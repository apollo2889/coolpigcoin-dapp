...
function App() {
  ...
  const contractAddress = '0x6dB01e7e5F39c77481556f859C339986cCd50fC4';
  ...
  const getTokenInfo = async () => {
    try {
      if (window.ethereum) {
        ...
        let myBalance = await tokenContract.balanceOf(account);
        tokenSupply = utils.formatEther(tokenSupply)
        myBalance = utils.formatEther(myBalance)
  ...
  return (
    <main className="main-container">
      ...
      <section className="px-10 pt-5 pb-10 customer-section">
        ...
        <div className="mt-5">
          <span className="mr-2"><strong>Coin:</strong> {tokenName} </span>
          <span className="mr-2"><strong>Ticker:</strong>  {tokenSymbol} </span>
          <span className="mr-2"><strong>Total Supply:</strong>  {tokenTotalSupply}</span>
          <span className="mr-2"><strong>My Balance:</strong>  {myBalance}</span>
        </div>
